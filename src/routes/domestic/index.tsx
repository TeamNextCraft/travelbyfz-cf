			...
			<section className="page-wrap py-8">
				...
				<div className="mt-6 grid gap-6 lg:grid-cols-[1fr_0.85fr] lg:items-stretch">
					<Card className="island-shell rounded-lg bg-transparent p-6 sm:p-8">
						<p className="island-kicker">Domestic tours</p>
						<h1 className="display-title mt-3 text-4xl font-bold leading-tight sm:text-5xl">
							Local touring spots and short trips planned end to end.
						</h1>
						<p className="mt-4 max-w-2xl text-base leading-7 text-[var(--sea-ink-soft)]">
							Build a separate domestic booking experience for sightseeing,
							family outings, weekend stays, transport, and guided group plans.
						</p>

						<div className="mt-8 grid gap-3 sm:grid-cols-3">
							{[
								["Custom routes", MapPinned],
								["Flexible dates", CalendarDays],
								["Group packages", UsersRound],
							].map(([label, Icon]) => (
								<CardContent
									key={label as string}
